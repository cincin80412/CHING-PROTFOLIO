...
}).prototype = getMCSymbolPrototype(lib.bg_1, new cjs.Rectangle(-207,-188,300,250), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(539.5,282.8);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(198).to({_off:false},0).to({x:549.5,alpha:1},81,cjs.Ease.quadInOut).wait(73).to({alpha:0},10).wait(1));

	// 姿
	this.instance_1 = new lib.ss7();
	this.instance_1.parent = this;
	this.instance_1.setTransform(511,282.8);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(198).to({_off:false},0).to({x:521,alpha:1},47,cjs.Ease.quadInOut).wait(107).to({alpha:0},10).wait(1));

	// 麗
	this.instance_2 = new lib.ss6();
	this.instance_2.parent = this;
	this.instance_2.setTransform(483.8,282.8);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(198).to({_off:false},0).to({x:493.8,alpha:1},35,cjs.Ease.quadInOut).wait(119).to({alpha:0},10).wait(1));

	// 美
	this.instance_3 = new lib.ss5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(465.5,282.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(198).to({_off:false},0).to({alpha:1},81,cjs.Ease.quadInOut).wait(73).to({alpha:0},10).wait(1));

	// 活
	this.instance_4 = new lib.ss4();
	this.instance_4.parent = this;
	this.instance_4.setTransform(438.3,282.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(198).to({_off:false},0).to({alpha:1},99,cjs.Ease.quadInOut).wait(55).to({alpha:0},10).wait(1));

	// 生
	this.instance_5 = new lib.ss3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(420,282.8);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(198).to({_off:false},0).to({x:410,alpha:1},47,cjs.Ease.quadInOut).wait(107).to({alpha:0},10).wait(1));

	// 放
	this.instance_6 = new lib.ss2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(382.8,282.8);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(198).to({_off:false},0).to({alpha:1},99,cjs.Ease.quadInOut).wait(55).to({alpha:0},10).wait(1));

	// 綻
	this.instance_7 = new lib.ss1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(365.4,282.8);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(198).to({_off:false},0).to({x:355.4,alpha:1},35,cjs.Ease.quadInOut).wait(119).to({alpha:0},10).wait(1));

	// 刷
	this.instance_8 = new lib.s9();
	this.instance_8.parent = this;
	this.instance_8.setTransform(553,246.6);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(198).to({_off:false},0).to({x:563,alpha:1},98,cjs.Ease.quadInOut).wait(56).to({alpha:0},10).wait(1));

	// 牙
	this.instance_9 = new lib.s8();
	this.instance_9.parent = this;
	this.instance_9.setTransform(525,246.6);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(198).to({_off:false},0).to({x:535,alpha:1},81,cjs.Ease.quadInOut).wait(73).to({alpha:0},10).wait(1));

	// 動
	this.instance_10 = new lib.s7();
	this.instance_10.parent = this;
	this.instance_10.setTransform(508.3,246.6);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(198).to({_off:false},0).to({alpha:1},81,cjs.Ease.quadInOut).wait(73).to({alpha:0},10).wait(1));

	// 電
	this.instance_11 = new lib.s6();
	this.instance_11.parent = this;
	this.instance_11.setTransform(480.5,246.6);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(198).to({_off:false},0).to({alpha:1},49,cjs.Ease.quadInOut).wait(105).to({alpha:0},10).wait(1));

	// 品
	this.instance_12 = new lib.s5();
	this.instance_12.parent = this;
	this.instance_12.setTransform(452,246.6);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(198).to({_off:false},0).to({alpha:1},49,cjs.Ease.quadInOut).wait(105).to({alpha:0},10).wait(1));

	// 精
	this.instance_13 = new lib.s4();
	this.instance_13.parent = this;
	this.instance_13.setTransform(434.5,246.6);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(198).to({_off:false},0).to({x:424.5,alpha:1},81,cjs.Ease.quadInOut).wait(73).to({alpha:0},10).wait(1));

	// 製
	this.instance_14 = new lib.s3();
	this.instance_14.parent = this;
	this.instance_14.setTransform(407.3,246.6);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(198).to({_off:false},0).to({x:397.3,alpha:1},49,cjs.Ease.quadInOut).wait(105).to({alpha:0},10).wait(1));

	// 國
	this.instance_15 = new lib.s2();
	this.instance_15.parent = this;
	this.instance_15.setTransform(378.6,246.6);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(198).to({_off:false},0).to({x:368.6,alpha:1},35,cjs.Ease.quadInOut).wait(119).to({alpha:0},10).wait(1));

	// 德
	this.instance_16 = new lib.s1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(341.2,246.6);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(198).to({_off:false},0).to({alpha:1},98,cjs.Ease.quadInOut).wait(56).to({alpha:0},10).wait(1));

	// new_2.png
	this.instance_17 = new lib.new2();
	this.instance_17.parent = this;
	this.instance_17.setTransform(451.5,140.5);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(183).to({_off:false},0).to({alpha:1},15).wait(154).to({alpha:0},10).wait(1));

	// btn.png
	this.instance_18 = new lib.btn_1();
	this.instance_18.parent = this;
	this.instance_18.setTransform(458.5,368);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(217).to({_off:false},0).to({alpha:1},16).wait(119).to({alpha:0},10).wait(1));

	// bg2.jpg
	this.instance_19 = new lib.bg2_1();
	this.instance_19.parent = this;
	this.instance_19.setTransform(300,250);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(174).to({_off:false},0).to({alpha:1},15).wait(163).to({alpha:0},10).wait(1));

	// st4
	this.instance_20 = new lib.st4_1();
	this.instance_20.parent = this;
	this.instance_20.setTransform(296.4,454.9,1.506,1.506,0,0,0,0.4,0.5);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(17).to({_off:false},0).to({regX:0.2,x:385.1,alpha:1},61,cjs.Ease.get(1)).wait(82).to({alpha:0},14).to({_off:true},1).wait(188));

	// st3
	this.instance_21 = new lib.st3_1();
	this.instance_21.parent = this;
	this.instance_21.setTransform(297.3,455.2,1.506,1.506,0,0,0,0.4,0.5);
	this.instance_21.alpha = 0;
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(17).to({_off:false},0).to({x:354.9,alpha:1},48,cjs.Ease.get(0.5)).wait(95).to({alpha:0},14).to({_off:true},1).wait(188));

	// st2
	this.instance_22 = new lib.st2_1();
	this.instance_22.parent = this;
	this.instance_22.setTransform(295.3,455.6,1.506,1.506,0,0,0,0.4,0.6);
	this.instance_22.alpha = 0;
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(17).to({_off:false},0).to({regX:0.2,x:322.9,alpha:1},56).wait(87).to({alpha:0},14).to({_off:true},1).wait(188));

	// st1
	this.instance_23 = new lib.st1_1();
	this.instance_23.parent = this;
	this.instance_23.setTransform(295.3,454.9,1.506,1.506,0,0,0,0.4,0.5);
	this.instance_23.alpha = 0;
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(17).to({_off:false},0).to({alpha:1},63,cjs.Ease.get(0.5)).wait(80).to({alpha:0},14).to({_off:true},1).wait(188));

	// new.png
	this.instance_24 = new lib._new_1();
	this.instance_24.parent = this;
	this.instance_24.setTransform(239.2,434,1.506,1.506,0,0,0,0.4,0.4);
	this.instance_24.alpha = 0;
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(43).to({_off:false},0).to({alpha:1},42,cjs.Ease.quadOut).wait(75).to({alpha:0},14).to({_off:true},1).wait(188));

	// GENIUS.png
	this.instance_25 = new lib.cenius();
	this.instance_25.parent = this;
	this.instance_25.setTransform(339.8,421.6,1.537,1.537,0,0,0,0.5,0.3);
	this.instance_25.alpha = 0;
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(52).to({_off:false},0).to({alpha:1},40).wait(68).to({alpha:0},14).to({_off:true},1).wait(188));

	// t2.png
	this.instance_26 = new lib.t2_1();
	this.instance_26.parent = this;
	this.instance_26.setTransform(333.5,434.3,1.506,1.506,0,0,0,0.4,0.5);
	this.instance_26.alpha = 0;
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(14).to({_off:false},0).to({x:446.5,alpha:1},107,cjs.Ease.cubicOut).wait(39).to({alpha:0},14).to({_off:true},1).wait(188));

	// t1.png
	this.instance_27 = new lib.t1_1();
	this.instance_27.parent = this;
	this.instance_27.setTransform(287.2,438.7,1.506,1.506,0,0,0,0.2,0.2);
	this.instance_27.alpha = 0;
	this.instance_27._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(14).to({_off:false},0).to({regX:0.1,regY:0.6,x:164.4,y:436.8,alpha:1},107,cjs.Ease.cubicOut).wait(39).to({alpha:0},14).to({_off:true},1).wait(188));

	// bg.jpg
	this.instance_28 = new lib.bg_1();
	this.instance_28.parent = this;
	this.instance_28.setTransform(414,376,2,2);
	this.instance_28.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).to({alpha:1},17).wait(143).to({alpha:0},14).to({_off:true},1).wait(188));
