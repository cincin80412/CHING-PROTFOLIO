...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[322,189,320,187],[322,0,320,187],[644,189,320,187],[644,0,320,187],[966,0,23,35],[0,0,320,480]]}
];
...
}).prototype = getMCSymbolPrototype(lib.abg_1, new cjs.Rectangle(0,0,320,480), null);
...
}).prototype = getMCSymbolPrototype(lib.a04_1, new cjs.Rectangle(0,0,320,187), null);
...
}).prototype = getMCSymbolPrototype(lib.a03_1, new cjs.Rectangle(0,0,320,187), null);
...
}).prototype = getMCSymbolPrototype(lib.a02_1, new cjs.Rectangle(0,0,320,187), null);
...
}).prototype = getMCSymbolPrototype(lib.a01_1, new cjs.Rectangle(0,0,320,187), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(269.5,455.5,1,1,0,0,0,11.5,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:278.5},12).to({x:269.5},11).to({x:278.5},12).to({x:269.5},11).to({x:278.5},12).to({x:269.5},11).to({x:278.5},12).to({x:269.5},11).to({x:278.5},12).to({x:269.5},11).to({x:278.5},12).wait(10));

	// a04.jpg
	this.instance_1 = new lib.a04_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.3,186,1,1,0,0,0,150,138);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(30).to({_off:false},0).wait(37).to({_off:true},1).wait(69));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1507815712598", id:"index_atlas_"}
	],
	preloads: []
};
